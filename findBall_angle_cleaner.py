...
def walkUp(cm, delta):
    ...
    while cm[0] < 420 and cm[0] > 0:
        ...
        if cm[0] == 0 and cm[1] == 0:
            ...
            # zero_head()
            # motion.moveTo(0.2, 0, alpha*7/6 + math.pi*7/180)
...
def walkDown(cm, delta):
    ...
    print 'Pitching, entering sub-precise with cm[0]', cm[0]
